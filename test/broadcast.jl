...
@test @inferred(Broadcast.indices(zeros(3,4), zeros(3,4))) == (OneTo(3),OneTo(4))
@test @inferred(Broadcast.indices(zeros(3,4), zeros(3)))   == (OneTo(3),OneTo(4))
@test @inferred(Broadcast.indices(zeros(3),   zeros(3,4))) == (OneTo(3),OneTo(4))
@test @inferred(Broadcast.indices(zeros(3), zeros(1,4), zeros(1))) == (OneTo(3),OneTo(4))
...
let
    ...
    g() = (a = 1; Broadcast.broadcast_eltype(x -> x + a, 1.0))
...
let f() = (a = 1; Broadcast.broadcast_eltype((x, y) -> x + y + a, 1.0, 1.0))
